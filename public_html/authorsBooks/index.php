                ...
                foreach ($result as $row) :  ?>
                    <div class="col-lg-3 col-md-4 col-6">
                        <a class="d-block mb-4 h-100">
                            ...
                            <?= '<img class="img-fluid img-thumbnail" style="min-width:100%; max-width:100%; min-height:200px; max-height:200px;" src="/PHP-OOP-CRUD/static/' . $row->book_image . ' " alt="picture" />'; ?>
                        </a>
                    </div>
                <?php endforeach; ?>
            </div>
